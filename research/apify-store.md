...
## Ключові факти
- Модель pay-per-event (PPE) — стандарт; rental припиняється 01.10.2026 (VERIFIED, blog.apify.com).
- Автору 80% доходу мінус витрати платформи (VERIFIED, docs.apify.com).
- Виплати: мін. $20 через PayPal, $100 банком; щомісячно (VERIFIED, help.apify.com).
- Фізособи можуть отримувати виплати (18+, KYC) (VERIFIED).
